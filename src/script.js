...
/*Verifie si l'adresse mail est au bon format */
 $regex_mail = '/^[-+.w]{1,64}@[-.w]{1,64}.[-.w]{2,6}$/i'; 
 /*Verifie qu il n y est pas d en tête dans les données*/
$regex_head = '/[nr]/';   
/*Verifie qu il n y est pas d erreur dans adresse mail*/
...
/*Le destinataire*/
$to="lydia.elizabeth.abbas@gmail.com";
...
$headers = 'From: MESSAGE DU SITE FAFA<lydia.elizabeth.abbas@gmail.com>'."rn";
$headers .= "rn";
